<h1>LetsChatAPP:-  RealTime Chat Application</h1>

***Here I am using socket.io where we don't need to implement everything from scratch like defining the type of the socket***
